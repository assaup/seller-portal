      ...
      <section className={styles.adsList}>
        <div className={styles.filters}>
          <div className={styles.search}>
            <label className="visually-hidden" htmlFor="search">Поиск объявлений</label>
            <input 
                id="search"
                type="text" 
        ...
        <div className={styles.content}>
          <aside className={styles.aside}>
            ...
            <button className={styles.aside__resetBtn} onClick={resetFilters}>Сбросить фильтры</button>
          </aside>
